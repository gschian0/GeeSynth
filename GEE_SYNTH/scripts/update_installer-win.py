...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=GEE_SYNTH Demo Installer\n"
      else:
        line="OutputBaseFilename=GEE_SYNTH Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the GEE_SYNTH Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the GEE_SYNTH installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=GEE_SYNTH Demo installer\n"
     else:
       line="SetupWindowTitle=GEE_SYNTH installer\n"
